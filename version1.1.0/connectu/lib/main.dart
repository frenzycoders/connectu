...
void main() async {
  ...
  runApp(const ConnectU());
}

class ConnectU extends StatelessWidget {
  const ConnectU({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(name: '/permission-screen', page: () => const PermissionScreen()),
        GetPage(name: '/home', page: () => const MainScreen(), bindings: [
          RTCbinding(),
          ContactBinding(),
          ChatsBinding(),
        ]),
        GetPage(name: '/archive-chats', page: () => const ArchiveScreen()),
        GetPage(name: '/search-screen', page: () => const SearchScreen()),
        GetPage(name: '/add-friend', page: () => const AddFriendScreen()),
        GetPage(name: '/chats-screen', page: () => const ChatScreen()),
        GetPage(
